...
#' \item{enrich_p1}{two tailed P-value for t1/R^2 is significantly different from exp1}
#' \item{enrich_p1_one_tail}{one tailed P-value for t1/R^2 is significantly different from exp1}
#' \item{enrich_p2}{P-value for t2/R2 is significantly different from (1-exp1)}
#' \item{enrich_p2_one_tail}{one tailed P-value for t2/R2 is significantly different from (1-exp1)}
#' @examples
...
#' #0.004980285
#' 
#' #output$ratio1 (t1/R^2)
#' #0.4392572
#' 
#' #output$ratio2 (t2/R^2)
#' #0.1956205
#' 
...
#' #-0.2113493
#' 
#' #output$enrich_p1 (two tailed P-value for t1/R^2 is significantly different from exp1)
#' #0.1591692
#' 
#' #output$enrich_p1_one_tail (one tailed P-value for t1/R^2 is significantly different from exp1)
#' #0.07958459
#' 
#' #output$enrich_p2 (P-value for t2/R2 is significantly different from (1-exp1))
#' #0.000232035
#' 
#' #output$enrich_p2_one_tail (one tailed P-value for t2/R2 is significantly different from (1-exp1))
#' #0.0001160175
